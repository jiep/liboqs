...
#define OQS_KEM_classic_mceliece_348864_length_coins 436 // =3488/8
...
OQS_API OQS_STATUS OQS_KEM_classic_mceliece_348864_encaps(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *coins);
...
#define OQS_KEM_classic_mceliece_348864f_length_coins 436 // =3488/8
...
OQS_API OQS_STATUS OQS_KEM_classic_mceliece_348864f_encaps(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *coins);
...
OQS_API void OQS_KEM_classic_mceliece_348864f_gen_e(uint8_t *e);
#endif
...
#define OQS_KEM_classic_mceliece_460896_length_coins 576 // =4608/8
...
OQS_API OQS_STATUS OQS_KEM_classic_mceliece_460896_encaps(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *coins);
...
OQS_API void OQS_KEM_classic_mceliece_460896_gen_e(uint8_t *e);
#endif
...
#define OQS_KEM_classic_mceliece_460896f_length_coins 576 // =4608/8
...
OQS_API OQS_STATUS OQS_KEM_classic_mceliece_460896f_encaps(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *coins);
...
OQS_API void OQS_KEM_classic_mceliece_460896f_gen_e(uint8_t *e);
#endif
...
#define OQS_KEM_classic_mceliece_6688128_length_coins 836 // =6688/8
...
OQS_API OQS_STATUS OQS_KEM_classic_mceliece_6688128_encaps(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *coins);
...
OQS_API void OQS_KEM_classic_mceliece_6688128_gen_e(uint8_t *e);
#endif
...
#define OQS_KEM_classic_mceliece_6688128f_length_coins 836 // =6688/8
...
OQS_API OQS_STATUS OQS_KEM_classic_mceliece_6688128f_encaps(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *coins);
...
OQS_API void OQS_KEM_classic_mceliece_6688128f_gen_e(uint8_t *e);
#endif
...
#define OQS_KEM_classic_mceliece_6960119_length_coins 870 // =6960/8
...
OQS_API OQS_STATUS OQS_KEM_classic_mceliece_6960119_encaps(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *coins);
...
OQS_API void OQS_KEM_classic_mceliece_6960119_gen_e(uint8_t *e);
#endif
...
#define OQS_KEM_classic_mceliece_6960119f_length_coins 870 // =6960/8
...
OQS_API OQS_STATUS OQS_KEM_classic_mceliece_6960119f_encaps(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *coins);
...
#define OQS_KEM_classic_mceliece_8192128_length_coins 1024 // =8192/8
...
OQS_API OQS_STATUS OQS_KEM_classic_mceliece_8192128_encaps(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *coins);
...
OQS_API void OQS_KEM_classic_mceliece_8192128_gen_e(uint8_t *e);
#endif
