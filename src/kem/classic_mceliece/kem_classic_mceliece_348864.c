...
OQS_KEM *OQS_KEM_classic_mceliece_348864_new() {
	...
	kem->length_coins = OQS_KEM_classic_mceliece_348864_length_coins;
	...
	kem->gen_e = OQS_KEM_classic_mceliece_348864_gen_e;

	return kem;
}

extern int PQCLEAN_MCELIECE348864_VEC_crypto_kem_keypair(uint8_t *pk, uint8_t *sk);
extern int PQCLEAN_MCELIECE348864_VEC_crypto_kem_enc(uint8_t *ct, uint8_t *ss, const uint8_t *pk, const uint8_t *coins);
extern int PQCLEAN_MCELIECE348864_VEC_crypto_kem_dec(uint8_t *ss, const uint8_t *ct, const uint8_t *sk);
extern void PQCLEAN_MCELIECE348864_VEC_crypto_kem_gen_e(uint8_t *e);
...
extern int PQCLEAN_MCELIECE348864_AVX_crypto_kem_enc(uint8_t *ct, uint8_t *ss, const uint8_t *pk, const uint8_t *coins);
extern int PQCLEAN_MCELIECE348864_AVX_crypto_kem_dec(uint8_t *ss, const uint8_t *ct, const uint8_t *sk);
extern void PQCLEAN_MCELIECE348864_AVX_crypto_kem_gen_e(uint8_t *e);
#endif
